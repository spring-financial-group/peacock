...
export JENKINS_X_URL='https://dashboard-jx.jx.mqube.build/spring-financial-group/peacock/HEAD/1'
...
export MINK_IMAGE='jx3mqubebuild.azurecr.io/spring-financial-group/peacock:0.2.1'
