...
export JENKINS_X_URL='https://dashboard-jx.jx.mqube.build/spring-financial-group/peacock/main/20'
...
export MINK_IMAGE='jx3mqubebuild.azurecr.io/spring-financial-group/peacock:1.14.1'
